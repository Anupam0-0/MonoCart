...
const Navbar = () => {
  ...
  //dynamic search icon only visible on collection page
  ...
  return (
    <div className="flex items-center justify-between py-3 mb-2 font-medium">
      ...
      <div className="flex items-center gap-6 mt-3">
        ...
        <NavLink to="/cart" className="relative">
          <img
            ...
            alt=""
          />
          <div className="absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-square roundedd-full text-[8px] ">
            {getCartCount()}
          </div>
        </NavLink>
        ...
        <img
          ...
          className="w-5 cursor-pointer md:hidden mt-"
          alt="MENU"
        />
      </div>
      ...
      <div
        className={`absolute  top-0 right-0 bottom-0 overflow-hidden bg-slate-50 transition-all delay-75 duration-[900ms] ${
          visible ? "w-1/2" : "w-0"
        }`}
      >
        <div className="flex flex-col py-3 px-2 text-gray-700">
          <div
            ...
            className="flex items-center gap-4 p-3 px-5 mb-4"
          >
